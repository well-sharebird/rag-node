...
from packages.rag.services.parsing_service import parse_document, parse_document_structured
from packages.rag.services.chunking_service import chunk_text, Chunk
...
async def resolve_embedding_params() -> dict:
    ...
    """
    from packages.core.database import async_session_factory
    from packages.model_gateway.services.model_config_service import resolve_embedding_config
...
async def _model_to_params(model, session) -> dict:
    ...
    from packages.model_gateway.services.model_config_service import get_provider_config
