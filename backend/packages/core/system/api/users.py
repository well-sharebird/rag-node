...
from packages.core.system.models.user import User, Role, Permission, AuditLog
...
async def assign_user_roles(
    ...
    """
    from packages.core.database import get_sync_db
...
async def _log_audit(
    ...
    from packages.core.auth import log_audit
    await log_audit(
        request=request,
        current_user=current_user,
        action=action,
