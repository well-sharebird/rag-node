...
from packages.core.infra.prometheus_client import (
...
async def prometheus_metrics():
    ...
    """
    from packages.core.infra.prometheus_client import get_prometheus_metrics, get_metrics_content_type
...
async def metrics_json():
    ...
    """
    from packages.core.infra.prometheus_client import REGISTRY
