...
from packages.prompt.models.prompt_template import PromptVersion, PromptTestCase
from packages.prompt.services.registry import PromptRegistryService
from packages.prompt.services.renderer import PromptRenderer
...
"""
    ...
    async def _get_template_by_id(self, template_id: int):
        ...
        from packages.prompt.models.prompt_template import PromptTemplate
