...
from packages.core.infra.milvus_client import check_milvus_health
from packages.core.infra.redis_client import check_redis_health
from packages.core.infra.minio_client import check_minio_health
from packages.core.config import settings as app_settings
from packages.core.system.schemas.dashboard import DashboardStats, ServiceStatus, QualityMetrics, QualityTrendPoint, TopDocItem, TopDocsResponse
...
async def get_dashboard_stats(db: AsyncSession, milvus, redis: aioredis.Redis) -> DashboardStats:
    ...
    try:
        from packages.model_gateway.services.model_config_service import get_default_model, ModelType
