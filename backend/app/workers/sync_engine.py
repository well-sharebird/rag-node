...
from app.connectors.base import Document as ConnectorDocument
from app.models.data_source import DataSource, SyncJob, SyncedItem
from app.services.parsing_service import parse_text
...
async def _resolve_embedding() -> dict:
    ...
    from app.workers.document_pipeline import resolve_embedding_params
