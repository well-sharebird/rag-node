...
from app.mcp_integration.tools.kb_tools import KB_TOOLS, handle_kb_tool
from app.mcp_integration.tools.model_tools import MODEL_TOOLS, handle_model_tool
from app.mcp_integration.tools.prompt_tools import PROMPT_TOOLS, handle_prompt_tool
from app.mcp_integration.tools.agent_tools import AGENT_TOOLS, handle_agent_tool
