...
class MCPClient:
    ...
    async def initialize(self):
        ...
        from app.mcp_integration.tools.kb_tools import KB_TOOLS
        from app.mcp_integration.tools.model_tools import MODEL_TOOLS
        from app.mcp_integration.tools.prompt_tools import PROMPT_TOOLS
        from app.mcp_integration.tools.agent_tools import AGENT_TOOLS
    ...
    async def call_tool(self, name: str, arguments: Dict[str, Any]) -> Any:
        ...
        # 导入所有 handler
        from app.mcp_integration.tools.kb_tools import handle_kb_tool
        from app.mcp_integration.tools.model_tools import handle_model_tool
        from app.mcp_integration.tools.prompt_tools import handle_prompt_tool
        from app.mcp_integration.tools.agent_tools import handle_agent_tool
