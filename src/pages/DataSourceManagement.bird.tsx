...
import { Button, Card, CardHeader, CardBody, CardTitle, CardDescription, Badge, Input, Modal, Switch } from '@/src/components/bird';
...
export function DataSourceManagementBird() {
  const { t } = useI18n();
    ...
    <div className="flex-1 flex flex-col overflow-hidden bg-[#f9fafb]">
      ...
      <header className="h-[60px] px-6 bg-white flex items-center justify-between shrink-0 border-b border-[#e5e7eb]">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-[18px] font-semibold text-[#111827]">数据源管理</h1>
            <p className="text-[12px] text-[#6b7280]">管理外部数据源和同步任务</p>
          </div>
        </div>
                        ...
                        <TableCell>
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              {ds.description && (
                                <div className="text-[11px] text-[#9ca3af] truncate max-w-[200px]">{ds.description}</div>
                              )}
                            </div>
                          </div>
                        </TableCell>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-4">
          {presets.map((preset) => {
            ...
            return (
              <Card
                key={preset.id}
                className="cursor-pointer hover:border-[#7c3aed] hover:shadow-md transition-all"
              ...
              >
                <CardBody>
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                      <div className="font-medium text-[#111827]">{preset.name}</div>
                      <div className="text-[11px] text-[#9ca3af]">{SOURCE_TYPE_LABELS[preset.source_type]}</div>
                    </div>
                  </div>
                  <p className="text-[12px] text-[#6b7280] line-clamp-2">{preset.description}</p>
                </CardBody>
              </Card>
            );
          })}
      ...
      <Modal
        ...
        footer={
          <>
            ...
            <Button onClick={handleCreate} className="bg-[#7c3aed] hover:bg-[#6d28d9] text-white">
              创建
            </Button>
          </>
        }
      >
        <div className="space-y-4 py-4">
          <div className="space-y-2">
            <label className="text-[12px] font-medium text-[#4b5563]">名称</label>
            <Input
              value={formData.name}
          ...
          <div className="space-y-2">
            <label className="text-[12px] font-medium text-[#4b5563]">描述</label>
            <Input
          ...
          <div className="space-y-2">
            <label className="text-[12px] font-medium text-[#4b5563]">知识库</label>
            <Select
          ...
          <div className="space-y-2">
            <label className="text-[12px] font-medium text-[#4b5563]">同步模式</label>
            <Select
          ...
          <div className="flex items-center justify-between py-2">
            <label className="text-[14px] font-medium text-[#4b5563]">启用数据源</label>
            <Switch
